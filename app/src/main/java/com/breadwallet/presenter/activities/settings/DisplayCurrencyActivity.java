...
//    private float rate;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (unit == BRConstants.CURRENT_UNIT_ROGERS) {
            setButton(true);
        } else {
            setButton(false);
        }
    ...
    private void updateExchangeRate() {
        ...
        if (entity != null) {
            ...
            boolean rogits = BRSharedPrefs.getCurrencyUnit(this) == BRConstants.CURRENT_UNIT_ROGITS;
            exchangeText.setText(BRCurrency.getFormattedCurrencyString(this, "ROGER", new BigDecimal(rogits ? 1000 : 1)) + " = " + finalExchangeRate);
        }
        adapter.notifyDataSetChanged();
    }
    ...
    private void setButton(boolean left) {
        if (left) {
            BRSharedPrefs.putCurrencyUnit(this, BRConstants.CURRENT_UNIT_ROGERS);
            ...
            BRSharedPrefs.putCurrencyUnit(this, BRConstants.CURRENT_UNIT_ROGITS);
